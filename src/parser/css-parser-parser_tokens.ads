   ...
   subtype yystype is CSS.Parser.YYstype;
    ...
    type Token is
        (End_Of_Input, Error, T_Name, T_Class,
         ...
         '=', '.', '!',
         '~', '%', '<',
         '>', T_Import_Sym, T_Charset_Sym,
         T_Media_Sym, T_Page, S,
         T_Cdo, T_Cdc, T_Hash,
         T_Function, T_Angle, T_Includes,
         T_Page_Sym, T_Percentage, T_Dashmatch,
         T_Dimension, T_Bad_String, T_Bad_Uri,
         T_Not, T_Prefixmatch, T_Suffixmatch,
         T_Substringmatch, ';', '{',
         '}', ',', ':',
         '/', '+', '-',
         '*' );
